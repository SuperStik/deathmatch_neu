...
function GM:PlayerNoClip(ply, state)
	if not IsValid(ply) then return false
	elseif ply:IsAdmin() and ply:Alive() and adminfly:GetBool() then return true
	else return playerfly:GetBool() or not state end
end
return include("player_class/player_deathmatch.lua")